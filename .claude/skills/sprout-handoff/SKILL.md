---
name: sprout-handoff
description: Orient Claude Code to the real Sprout repo, source-of-truth paths, branch law, product surfaces, stale-copy risk, and high-risk workflows. Use at the start of a Sprout task, when preparing a handoff, or when a session needs to rebuild the project's operating rules before editing.
---
