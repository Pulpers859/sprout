...
description: Keep Claude Code context lean in Sprout by rebuilding only the project state needed for the current task, choosing the right local skill, and producing compact handoffs. Use when starting a fresh session, resuming older work, preparing a handoff, or when docs, logs, or diffs may balloon context.
---
